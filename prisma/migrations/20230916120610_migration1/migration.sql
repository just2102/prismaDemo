...
-- CreateIndex
CREATE UNIQUE INDEX "_BlogArticleToCategory_AB_unique" ON "_BlogArticleToCategory"("A", "B");
...
-- AddForeignKey
ALTER TABLE "BlogArticle" ADD CONSTRAINT "BlogArticle_likedById_fkey" FOREIGN KEY ("likedById") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
